          ...
          <svg className="hero__waves-svg" viewBox="0 0 1440 450" preserveAspectRatio="none">
            ...
            <path fill="#ffffff">
              <animate 
                ...
                repeatCount="indefinite" 
                values="
                  M0,230 C280,260 400,340 540,390 C630,420 680,450 720,450 C760,450 810,420 900,390 C1040,340 1160,260 1440,230 L1440,450 L0,450 Z;
                  M0,245 C290,240 390,360 550,380 C640,400 670,470 720,470 C770,470 800,400 890,380 C1050,360 1150,240 1440,245 L1440,450 L0,450 Z;
                  M0,230 C280,260 400,340 540,390 C630,420 680,450 720,450 C760,450 810,420 900,390 C1040,340 1160,260 1440,230 L1440,450 L0,450 Z
                "
              />
            </path>
